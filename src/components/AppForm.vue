      ...
      <div class="mb-8 text-center text-2xl">
       ...
       <form @submit.prevent="onSubmit">
          <div class="form-group mb-2">
            <input type="text" placeholder="login" class="rounded border-2 border-rose-600 px-4 py-2 w-full" name="login" autocomplete="off"
              v-model="login"
          ...
          <div class="form-group mb-2">
            <input type="password" placeholder="password" class="rounded border-2 border-rose-600 px-4 py-2 w-full" name="password" 
              v-model="password"
          ...
          <div class="form-group mb-2">
            <button type="submit" class="cursor-pointer rounded text-white font-bold px-4 py-2 w-full uppercase bg-gray-500 hover:bg-gray-400 transition duration-150 ease-in-out" 
...
export default {
  setup() {
    ...
    // если форма не валидна, выводим сообщение
